...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function viewCustomer(id, name) {
        ...
        document.getElementById('viewModalBody').innerHTML = `
            <div class="text-center py-5">
                ...
                <p class="text-muted">Loading customer details for ${name}...</p>
            </div>
        `;
        viewModal.show();
    ...
    function editCustomer(id, name) {
        ...
        document.getElementById('editModalBody').innerHTML = `
            <div class="text-center py-5">
                ...
                <p class="text-muted">Loading edit form for ${name}...</p>
            </div>
        `;
        editModal.show();
    ...
    function displayEditForm(customer) {
        ...
        if (customer.last_contacted_at) {
            ...
            lastContactedValue = date.toISOString().slice(0, 16);
        }
    ...
    function updateSelectedCount() {
        ...
        document.getElementById('selectedCount').textContent = 
            selectedIds.length === 0 ? '0 selected' : `${selectedIds.length} selected`;
    }
        ...
        fetch('api/get-stats.php')
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('admittedCount').textContent = data.admittedCount || 0;
                    document.getElementById('pendingAdmissionCount').textContent = data.pendingAdmissionCount || 0;
