...
<div class="offcanvas offcanvas-start text-white" tabindex="-1" id="appSidebar" aria-labelledby="appSidebarLabel">
    <div class="offcanvas-body p-3">
        ...
        <li class="nav-item mb-2">
            <a href="index.php" class="nav-link text-white d-flex align-items-center p-3 rounded <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''; ?>" data-bs-toggle="tooltip" title="Dashboard">
        ...
        <li class="nav-item mb-2">
            <a href="account_executive.php" class="nav-link text-white d-flex align-items-center p-3 rounded <?php echo basename($_SERVER['PHP_SELF']) == 'account_executive.php' ? 'active' : ''; ?>" data-bs-toggle="tooltip" title="Account Executive">
                <span class="nav-icon me-3 d-flex align-items-center justify-content-center" style="width: 28px; height: 28px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <li class="nav-item mb-2">
            <a href="passport_visa.php" class="nav-link text-white d-flex align-items-center p-3 rounded <?php echo basename($_SERVER['PHP_SELF']) == 'passport_visa.php' ? 'active' : ''; ?>" data-bs-toggle="tooltip" title="Passport & Visa">
                <span class="nav-icon me-3 d-flex align-items-center justify-content-center" style="width: 28px; height: 28px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <li class="nav-item mb-2">
            <a href="schedule_rates.php" class="nav-link text-white d-flex align-items-center p-3 rounded <?php echo basename($_SERVER['PHP_SELF']) == 'schedule_rates.php' ? 'active' : ''; ?>" data-bs-toggle="tooltip" title="Schedule & Rates">
                <span class="nav-icon me-3 d-flex align-items-center justify-content-center" style="width: 28px; height: 28px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <li class="nav-item mb-2">
            <a href="crm.php" class="nav-link text-white d-flex align-items-center p-3 rounded <?php echo basename($_SERVER['PHP_SELF']) == 'crm.php' ? 'active' : ''; ?>" data-bs-toggle="tooltip" title="CRM">
                <span class="nav-icon me-3 d-flex align-items-center justify-content-center" style="width: 28px; height: 28px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <li class="nav-item mb-2">
            <a href="facilities.php" class="nav-link text-white d-flex align-items-center p-3 rounded <?php echo basename($_SERVER['PHP_SELF']) == 'facilities.php' ? 'active' : ''; ?>" data-bs-toggle="tooltip" title="Facilities Reservation">
                <span class="nav-icon me-3 d-flex align-items-center justify-content-center" style="width: 28px; height: 28px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                <span class="nav-text">Facilities Reservation</span>
            </a>
        </li>
        </ul>
