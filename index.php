...
// Random names arrays for dynamic data
$firstNames = ['John', 'Jane', 'Robert', 'Maria', 'Michael', 'Sarah', 'David', 'Lisa', 'James', 'Jennifer', 
...
// Generate random data for urgent action queue
$urgentActions = [];
$actionTypes = ['Passport', 'Document', 'Payment', 'Visa', 'Medical'];
$actionStatuses = [
...
for ($i = 0; $i < 5; $i++) {
    $urgentActions[] = [
        ...
        'type' => $actionTypes[array_rand($actionTypes)],
        'status' => $actionStatuses[array_rand($actionStatuses)],
        'deadline' => date('M. d, Y', strtotime('+' . rand(1, 10) . ' days'))
    ];
}

// Generate random data for upcoming departures
$upcomingDepartures = [];
$departureTimes = ['08:30 am', '11:30 am', '02:45 pm', '05:15 pm', '09:00 pm'];

for ($i = 0; $i < 2; $i++) {
    $upcomingDepartures[] = [
        'name' => generateRandomName($firstNames, $lastNames),
        'departure' => date('M d, Y', strtotime('+' . rand(0, 2) . ' days')) . ' - ' . $departureTimes[array_rand($departureTimes)]
    ];
}

// Generate random data for operations overview
$operations = [];
$staffNames = ['J. Rizz', 'M. Manuel', 'J. Paul', 'A. Rodriguez', 'S. Johnson', 'P. Martinez'];
$operationTypes = ['Transport', 'Accommodation', 'Tour Guide', 'Logistics'];
...
$urgentRatio = $urgentDocuments / ($urgentDocuments + $approvedDocuments);

// Generate random booking data
$usedSlots = rand(100, 120);
$totalSlots = 122;
$bookingPercentage = round(($usedSlots / $totalSlots) * 100);

// Generate random operational health
$operationalHealth = rand(70, 90);

// Generate random customer rating
$customerRating = round((rand(43, 49) / 10), 1);

// Generate random rating bars data
$ratingBars = [];
for ($i = 0; $i < 12; $i++) {
...
<body>
                    ...
                    <div class="metric-card highlight-card">
                        <div class="card-body">
                            ...
                            <div class="progress-value-index booking-slots-value-wrap">
                                <span class="progress-value"><?php echo $usedSlots; ?><p class="total-slots">/<?php echo $totalSlots; ?></p></span>
                            </div>
                            <div class="metric-progress-container">
                                <div class="progress-header">
                                    <span class="progress-percentage"><?php echo $bookingPercentage; ?>%</span>
                                </div>
                                <div class="progress-bar-custom">
                                    <div class="progress-fill-custom" style="width: <?php echo $bookingPercentage; ?>%;"></div>
                                </div>
                            </div>
                            <div class="mt-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="text-muted small">Available</span>
                                    <span class="fw-bold"><?php echo $totalSlots - $usedSlots; ?> slots</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-0">
                                <div class="urgent-document">
                                    <span class="urgent-document-text fw-bold text-danger"><?php echo $urgentDocuments; ?> <p class="urgency-status">Action Required</p></span>
                                </div>
                                <div class="document-status">
                                    <div class="status-bars">
                                        <div class="status-urgent" style="flex: <?php echo $urgentRatio; ?>;"></div>
                                        <div class="status-approved" style="flex: <?php echo 1 - $urgentRatio; ?>;"></div>
                                    </div>
    ...
    <script>
        ...
        window.dashboardData = {
            firstNames: <?php echo json_encode($firstNames); ?>,
            lastNames: <?php echo json_encode($lastNames); ?>
        };
    </script>
